...
export default function CompleteProfileForm() {
    ...
    const { google_user } = usePage<PageProps>().props;
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            username: google_user?.attributes.nickname ? google_user.attributes.nickname : '',
            birthdate: new Date(),
    ...
    const onSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        router.post(route('signup.store'), {
            ...
            avatar: google_user?.avatar ? google_user?.avatar : null,
        ...
        <GuestScreen>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    />
                    <Button variant={"outline"} className="border-0 bg-indigo-500 text-white hover:text-white hover:bg-indigo-600" type="submit">Войти</Button>
                </form>
            </Form>
